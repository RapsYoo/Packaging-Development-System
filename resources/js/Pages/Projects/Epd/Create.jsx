...
export default function Create({ auth, users }) {
    ...
    const submit = (e, isDraft = false) => {
        ...
        post(route('projects.epd.store'));
    };

    return (
        <AuthenticatedLayout user={auth.user} header="Buat Pengajuan Proyek (Project Brief EPD)">
            <Head title="Buat Project Brief EPD" />

            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div className="px-6 py-5 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between">
                        <h3 className="font-bold text-gray-800">Formulir EPD Brief</h3>
                        <Link href={route('projects.epd.index')} className="text-sm font-medium text-gray-500 hover:text-indigo-600 transition-colors">
                            &larr; Batal & Kembali
                        </Link>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="col-span-2">
                                    ...
                                    <input 
                                        ...
                                        placeholder="Contoh: Botol Parfum Varian X 100ml (EPD)"
                                    />
