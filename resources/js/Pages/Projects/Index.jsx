...
export default function Index({ auth, projects, filters }) {
    ...
    const handleFilter = (e) => {
        e.preventDefault();
        router.get(route('projects.index'), { search, type: typeFilter, status: statusFilter }, { preserveState: true });
    };
                    ...
                    <form onSubmit={handleFilter} className="mt-6 flex flex-col sm:flex-row gap-3">
                        ...
                        <div className="sm:w-48">
                            ...
                            >
                                ...
                                <option value="EPD">Existing Product (EPD)</option>
                                <option value="Substitusi">Substitusi Material</option>
                            </select>
                        </div>
                        <div className="sm:w-48">
                            <select 
