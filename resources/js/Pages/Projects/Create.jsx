...
export default function Create({ auth, users, preselectedType = 'NPD' }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header="Buat Pengajuan Proyek (Project Brief)">
            <Head title="Buat Project Brief" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="col-span-2">
                                    ...
                                    <input 
                                        ...
                                        placeholder="Contoh: Botol Parfum Varian X 100ml"
                                    />
